globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\atheer\\Downloads\\wetransfer_main_files_2024-07-07_0656\\Main_Files\\sixdegrees_nuxtjs","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\atheer\\Downloads\\wetransfer_main_files_2024-07-07_0656\\Main_Files\\sixdegrees_nuxtjs\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\atheer\\Downloads\\wetransfer_main_files_2024-07-07_0656\\Main_Files\\sixdegrees_nuxtjs\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\atheer\\Downloads\\wetransfer_main_files_2024-07-07_0656\\Main_Files\\sixdegrees_nuxtjs\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_y9Q1LJ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_y9Q1LJ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_y9Q1LJ, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/atheer/Downloads/wetransfer_main_files_2024-07-07_0656/Main_Files/sixdegrees_nuxtjs/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<title>6 Degrees Technologies</title>\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\n<meta name=\"keywords\" content=\"\">\n<meta name=\"description\" content=\"Where your technological future, comes today. The limits to technology uses is beyond imagination, digitize your life with us\">\n<meta name=\"author\" content=\"Six Degrees Technologies\">\n<link rel=\"shortcut icon\" href=\"/assets/imgs/favicon.ico\">\n<link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/css?family=Poppins:100,200,300,400,500,600,700,800,900&display=swap\">\n<link rel=\"stylesheet\" href=\"/assets/fonts/mona-sans/style.css\">\n<link rel=\"stylesheet\" href=\"/assets/css/plugins.css\">\n<link rel=\"stylesheet\" href=\"/assets/css/style.css\">\n<link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/bootstrap-icons/1.5.0/font/bootstrap-icons.min.css\">\n<script src=\"/assets/js/bootstrap.bundle.min.js\"></script>\n<script src=\"/assets/js/plugins.js\"></script>\n<script src=\"/assets/js/isotope.pkgd.min.js\"></script>\n<script src=\"/assets/js/wow.min.js\"></script>\n<script src=\"/assets/js/gsap.min.js\"></script>\n<script src=\"/assets/js/ScrollTrigger.min.js\"></script>\n<script src=\"/assets/js/ScrollSmoother.min.js\"></script>\n<script src=\"/assets/js/scripts.js\" defer=\"\"></script>\n<script src=\"https://unpkg.com/@splinetool/viewer@1.9.3/build/spline-viewer.js\" type=\"module\"></script>","bodyTags":"","bodyTagsOpen":"","htmlAttrs":" lang=\"en\"","bodyAttrs":""};
