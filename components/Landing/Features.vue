<template>
  ...
  <section class="py-[120px]">
    <div class="container">
      <!-- Section Heading -->
      <div class=" pb-20 bord-thin-bottom mb-[80px]">
        <div class="flex items-center">
          ...
          <div class="ml-auto rtl:ml-0 rtl:mr-auto">
            <div class="flex items-center">
              <!-- Subtitle with Link -->
              <span class="sub-title tracking-wide bord hidden md:flex">{{ $t('components.landing.features.section.allFeatures') }}</span>
              <NuxtLink :to="pageRout.toAboutPage()" class="ml-1 rtl:ml-0 rtl:mr-1 text-dark">
                <div class=" flex items-center justify-center w-10 h-10 rounded-full bg-[#34D8B1]">
                  <!-- Arrow SVG Icon -->
