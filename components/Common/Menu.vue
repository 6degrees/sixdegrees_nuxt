          ...
          <div class="menu-links">
            <ul class="main-menu m-0 p-0">
              <li @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
                <div class="o-hidden">
                  <NuxtLink :to="pageRout.toHomePage()" class="link animsition-link" @click="closeMenu"><span
              ...
              <li @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
                <div class="o-hidden">
                  <NuxtLink :to="pageRout.toContactPage()" class="link animsition-link" @click="closeMenu"><span
                      class="nm">05.</span>{{ $t('components.common.menu.section.menu.contact') }}
                  </NuxtLink>
                </div>
              </li>
            </ul>
        ...
        <div class="col-lg-4 valign">
          <div class="cont-info">
            <div class="item mb-50">
              <h6 class="uppercase font-semibold mb-20">{{ $t('components.common.menu.section.contactInfo.headQuarter.title') }}</h6>
              <p class="font-normal text-lg">{{ $t('components.common.menu.section.contactInfo.headQuarter.address') }}</p>
            </div>
            <div class="item mb-50">
              <h6 class="uppercase font-semibold mb-20">{{ $t('components.common.menu.section.contactInfo.howToConnect.title') }}</h6>
